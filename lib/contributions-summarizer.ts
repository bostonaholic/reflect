...
const CONTRIBUTIONS_SUMMARY_PROMPT = `You are an expert at summarizing technical contributions. 
...
export async function generateContributionsSummary(markdownContent: string, apiKey: string): Promise<string> {
  return callOpenAI(CONTRIBUTIONS_SUMMARY_PROMPT, markdownContent, apiKey);
} 