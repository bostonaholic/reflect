...
console.log(chalk.gray('- fetchGitHubData(username, dateRange)'));
console.log(chalk.gray('- fetchClosedIssues(username, dateRange)'));
console.log(chalk.gray('- fetchMergedPRs(username, dateRange)'));
console.log(chalk.gray('- callOpenAI(prompt, content, apiKey, debug)'));
console.log(chalk.gray('- checkFileExists(path)'));
